...
public class EmailSenderServiceImpl implements EmailSenderService {
    ...
    public void sendEmailAppointmentBookingInfo(AppointmentBookingInfo appointmentBookingInfo) {
        try {
            ...
            String emailContent = "<html>" +
                    ...
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getPatientName() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Giới tính:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getGender() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số thẻ bảo hiểm y tế:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getInsuranceNumber() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số điện thoại:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getPhoneNumber() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Dịch vụ đặt khám:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getServiceName() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Thời gian đặt:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getDateTime() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Ngày khám:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getDate() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Khung giờ khám:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getTimeFrame() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Thông tin bác sĩ:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getDoctorName() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số tiền thanh toán:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getPaymentAmount() + "</td></tr>" +
                    "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Trạng thái thanh toán:</strong></td>" +
                    "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentBookingInfo.getPaymentStatus() + "</td></tr>" +
            ...
            // Gửi email
            this.sendEmail(
                    appointmentBookingInfo.getEmailAddress(),
                    "Thông tin đặt lịch khám chữa bệnh",
                    emailContent
            );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void sendEmailAppointmentConfirmation(AppointmentConfirmation appointmentConfirmation)
    {
        try {
            ...
            String emailContent = "<html><body style='font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px; font-size: 16px;'>"
                    + "<div style='max-width: 600px; margin: 0 auto; background-color: white; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden;'>"
                    + "<div style='background-color: #3e8ed0; padding: 20px; color: white; text-align: center;'>"
                    + "<h1 style='margin: 0;'>Lịch hẹn đã được xác nhận</h1></div>"
                    + "<div style='padding: 20px;'>"
                    + "<p>Xin chào <strong>" + appointmentConfirmation.getPatientName() + "</strong>,</p>"
                    ...
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Họ tên người khám bệnh:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getPatientName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Giới tính:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getGender() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số bảo hiểm y tế:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getInsuranceNumber() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số điện thoại:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getPhoneNumber() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Dịch vụ đặt khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getServiceName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Ngày khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getDate() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Khung giờ khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getTimeFrame() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Thông tin bác sĩ:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + appointmentConfirmation.getDoctorName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Phòng khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + appointmentConfirmation.getRoomName() + "</strong></td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số thứ tự:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + appointmentConfirmation.getOrderNumber() + "</strong></td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Trạng thái lịch hẹn:</strong></td>"
    ...
    public void sendDoctorReplacementNotification(DoctorReplacementNotification notification) {
        try {
            ...
            String emailContent = "<html><body style='font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px; font-size: 16px;'>"
                    ...
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Họ tên người khám bệnh:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getPatientName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Giới tính:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getGender() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số bảo hiểm y tế:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getInsuranceNumber() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số điện thoại:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getPhoneNumber() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Dịch vụ đặt khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getServiceName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Ngày khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getDate() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Khung giờ khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getTimeFrame() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Thông tin bác sĩ:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getDoctorName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Phòng khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getRoomName() + "</td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số thứ tự:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'>" + notification.getOrderNumber() + "</td></tr>"
                    ...
                    + "<p style='text-align: justify;'>Tuy nhiên, Bác sĩ <strong>" + notification.getDoctorName() + "</strong> sẽ không thể tham gia khám bệnh vào ngày <strong>" + notification.getDate() + "</strong>.</p>"
                    ...
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + notification.getNewDoctorName() + "</strong></td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Phòng khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + notification.getNewRoomName() + "</strong></td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Khung giờ khám:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + notification.getNewTimeFrame() + "</strong></td></tr>"
                    + "<tr><td style='padding: 8px; border: 1px solid #e0e0e0;'><strong>Số thứ tự:</strong></td>"
                    + "<td style='padding: 8px; border: 1px solid #e0e0e0;'><strong style='color: #312697;'>" + notification.getNewOrderNumber() + "</strong></td></tr></table>"
