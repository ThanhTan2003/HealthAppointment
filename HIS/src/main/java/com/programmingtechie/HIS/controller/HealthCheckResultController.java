...
public class HealthCheckResultController {
    ...
    public ResponseEntity<String> generateFileUrlPublic(
        ...
        return ResponseEntity.ok(healthCheckResultService.generateFileUrlPublic(fileName, bucketName, expiryDateTime, hmac));
    }
    ...
    public ResponseEntity<PageResponse<HealthCheckResultResponse>> getHealthCheckResultResponseForMedicalAppointmentSystem(
        ...
        PageResponse<HealthCheckResultResponse> pageResponse = healthCheckResultService.getHealthCheckResultResponseForMedicalAppointmentSystem(startDate, endDate, expiryDateTime, page, size, hmac);

        return ResponseEntity.ok(pageResponse);
    }

    @GetMapping("/get/deleted/public/sync/from-medical-appointment-system")
    public ResponseEntity<PageResponse<HealthCheckResultsDeletedResponse>> getHealthCheckResultsDeletedForMedicalAppointmentSystem(
            @RequestParam("endDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime endDate,
            @RequestParam("expiryDateTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime expiryDateTime,
            @RequestParam("page") int page,
            @RequestParam("size") int size,
        ...
        return ResponseEntity.ok(healthCheckResultService.getHealthCheckResultsDeletedForMedicalAppointmentSystem(endDate, expiryDateTime, page, size, hmac));
    }
    ...
    public ResponseEntity<Void> deletedHealthCheckResultsDeletedForMedicalAppointmentSystem(
        ...
        return ResponseEntity.ok(healthCheckResultService.deletedHealthCheckResultsDeletedForMedicalAppointmentSystem(endDate, expiryDateTime, hmac));
    }
}
